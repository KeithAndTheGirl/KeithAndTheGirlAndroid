...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        mSelectedIndicatorColor = DEFAULT_SELECTED_INDICATOR_COLOR;
        mDividerColor = setColorAlpha(themeForegroundColor, DEFAULT_DIVIDER_COLOR_ALPHA);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            int color = mSelectedIndicatorColor;

            if (mSelectionOffset > 0f && mSelectedPosition < (getChildCount() - 1)) {
                int nextColor = mSelectedIndicatorColor;
                if (color != nextColor) {
