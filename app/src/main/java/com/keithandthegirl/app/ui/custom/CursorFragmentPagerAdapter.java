...
public abstract class CursorFragmentPagerAdapter extends FragmentPagerAdapter {
     ...
     *
     * @param fragmentManager Instance of the FragmentManager
    ...
    public CursorFragmentPagerAdapter(FragmentManager fragmentManager, Cursor cursor) {
        ...
        init(cursor, FLAG_AUTO_REQUERY);
    }

    /**
     * Constructor that allows control over auto-requery. It is recommended you not use this, but
     * instead {@link #CursorAdapter(android.support.v4.app.FragmentManager, android.database.Cursor, boolean)}. When using this constructor, {@link
     ...
     */
    public CursorFragmentPagerAdapter(FragmentManager fragmentManager, Cursor cursor, boolean autoRequery) {
        super(fragmentManager);
        init(cursor, autoRequery ? FLAG_AUTO_REQUERY : FLAG_REGISTER_CONTENT_OBSERVER);
    }
     ...
     */
    public CursorFragmentPagerAdapter(FragmentManager fragmentManager, Cursor c, int flags) {
        super(fragmentManager);
        init(c, flags);
    }
     ...
     */
    @Deprecated
    protected void init(Cursor cursor, boolean autoRequery) {
        init(cursor, autoRequery ? FLAG_AUTO_REQUERY : FLAG_REGISTER_CONTENT_OBSERVER);
    }
