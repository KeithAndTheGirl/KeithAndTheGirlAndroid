 ...
 */
public class Episode extends AbstractBaseDatabase {
    ...
    public static final String FIELD_TIMESTAMP = "posted";
    ...
    public static final String[] COLUMN_MAP = { _ID,
            FIELD_NUMBER, FIELD_TITLE, FIELD_PREVIEWURL, FIELD_FILEURL, FIELD_FILENAME, FIELD_LENGTH, FIELD_FILESIZE, FIELD_TYPE, FIELD_PUBLIC, FIELD_TIMESTAMP, FIELD_DOWNLOADED, FIELD_PLAYED, FIELD_LASTPLAYED, FIELD_SHOWNAMEID,
