 ...
 * <p>
 * A {@link com.google.android.exoplayer.SampleSource} may expose one or multiple tracks. The number of tracks and information
...
public interface SampleSource {
   ...
   * next piece of data to be returned from the {@link com.google.android.exoplayer.SampleSource} corresponds to a different
   ...
   * @throws java.io.IOException If an error occurred preparing the source.
   */
   ...
   * next piece of data to be read from the {@link com.google.android.exoplayer.SampleSource} corresponds to a different track
   ...
   * @throws java.io.IOException If an error occurred reading from the source.
   */
  ...
  /**
   * Releases the {@link com.google.android.exoplayer.SampleSource}.
   */
  public void release();
