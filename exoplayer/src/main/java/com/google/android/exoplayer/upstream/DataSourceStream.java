...
public final class DataSourceStream implements Loadable, NonBlockingInputStream {
  ...
  /**
   * Thrown when an error is encountered trying to load data into a {@link com.google.android.exoplayer.upstream.DataSourceStream}.
   */
  ...
  /**
   * Reads data to either a target {@link java.nio.ByteBuffer}, or to a target byte array at a specified
