...
public abstract class MediaCodecTrackRenderer extends TrackRenderer {
  ...
  /**
   * Interface definition for a callback to be notified of {@link com.google.android.exoplayer.MediaCodecTrackRenderer} events.
   */
   ...
   * @throws java.io.IOException If an error occurs reading data from the upstream source.
